    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                height: 50
                radius: 25
                color: reader.ledState ? "green" : "red"
                border.color: "white"
                border.width: 2
                Layout.alignment: Qt.AlignHCenter
            ...
            ProgressBar {
                from: 0
                to: 4095
                value: reader.batteryLevel
                Layout.preferredWidth: 250
                opacity: reader.brightness / 1000.0
            }

            Text {
                text: "PWM: " + reader.brightness
                color: "white"
                font.pixelSize: 16
                horizontalAlignment: Text.AlignHCenter
                Layout.alignment: Qt.AlignHCenter
